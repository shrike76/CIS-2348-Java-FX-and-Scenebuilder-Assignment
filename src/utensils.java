public class utensils extends Item implements Tax, Discount{
    final double taxp = 8.5;

    public utensils(int itemCode_, String Name_, int units_, double price_, String brand_, double discount_, String category_){
